...
_step '[04/19] Download and Install Kubectl'
...
_step '[05/19] Config Minikube Docker default driver'
minikube config set driver docker

_step '[06/19] Minikube Start'
minikube start --addons=$MINIKUBE_ADDONS --driver=docker --force
echo "----------"
_step_result_success "$(minikube status)"

_step '[07/19] Configure Kickoff Minikube Cluster on Machine Startup'
...
_step '[08/19] Enable Minikube Service'
...
_step '[09/19] Copy the certificates and keys'
...
_step '[15/19] Configure Kubeconfig to external access'
...
_step '[16/19] Show all Configuration Files'
...
_step '[17/19] Create Kubernetes Dashboard Ingress'
