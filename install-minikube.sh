...
# echo $SUDO_PASS | sudo -S touch /etc/systemd/system/minikube3.service

___console_logs 'ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ'
echo toor | sudo -S cat > /etc/systemd/system/minikube3.service <<- "EOF" 
[Unit]
...
systemctl cat /etc/systemd/system/minikube3.service
