...
# echo "==> Copiar os arquivos de conexão externa gerados pela instalação do minikube: scp -r $SO_MINIKUBE_USER@$IP:/home/$SO_MINIKUBE_USER/nginx/minikube/ target_folder"
