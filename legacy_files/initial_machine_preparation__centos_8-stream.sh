...
echo '##########################################################################'
echo '############# INITIAL MACHINE PREPARATION [CentOS 8 - Stream] ############'
echo '##########################################################################'
...
___console_logs 'Installing Basic Applications'
...
___console_logs 'Installing the Firewalld package'
dnf install -y firewalld

___console_logs 'Starting the Firewalld service'
systemctl start firewalld

___console_logs 'Enabling Firewalld service'
